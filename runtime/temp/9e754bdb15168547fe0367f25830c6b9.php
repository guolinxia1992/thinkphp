...
<body>
    ...
    <form action="<?php echo url(); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="tel" value="<?php echo isset($info['tel']) ? $info['tel'] : ''; ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">地址</label>
            <div class="controls">
                <input type="text" class="text input-large" name="address" value="<?php echo isset($info['address']) ? $info['address'] : ''; ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">内容</label>
            <div class="controls">
                <textarea name="content" id="" cols="54" rows="10"  class="textarea input-large"><?php echo isset($info['content']) ? $info['content'] : ''; ?></textarea>
