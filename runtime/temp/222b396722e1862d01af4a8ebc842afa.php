<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/manage\index.html";i:1552645546;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="title" class="search-input" value="<?php echo input('title'); ?>" placeholder="请输入用户昵称或者ID">
    ...
    <tbody>
		<?php if(!(empty($manages) || (($manages instanceof \think\Collection || $manages instanceof \think\Paginator ) && $manages->isEmpty()))): if(is_array($manages) || $manages instanceof \think\Collection || $manages instanceof \think\Paginator): $i = 0; $__LIST__ = $manages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		<tr>
    ...
    //导航高亮
    highlight_subnav("<?php echo url('Manage/index'); ?>");
	</script>
